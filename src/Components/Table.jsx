...
const Table = ({ heading }) => {
    ...
    const handleClick = (index) => {
        ...
        console.log(index)// Update selected row index
    };
                            ...
                            items.length > 0 ? (
                                ...
                                items.map((item, index) => (
                                    <tr 
                                        key={item.id} 
                                        className={`
                                            ${index === selectedIndex ? "bg-orange-600" : "bg-white border-b dark:bg-gray-800 dark:border-gray-700"}
                                        `}
                                    >
                                        <th 
                                            scope="row" 
                                ...
                                <tr>
                                    <td className='px-6 py-4 text-2xl font-bold text-red-700'>
                                        No item found😞
                                    </td>
                                </tr>
                            )
